...
const Language = ({ onCountryChange }) => {
    ...
    return (
        ...
        <select id="country-language" name="country-language" onChange={handleChange} required>
            <option value="" disabled selected>Select country and language</option>
            <option value="hong-kong-chinese-traditional">Hong Kong - Chinese Traditional</option>
            <option value="taiwan-chinese-traditional">Taiwan - Chinese Traditional</option>
            ...
            <option value="united-arab-emirates-arabic">United Arab Emirates - Arabic</option>
            ...
            <option value="singapore-chinese-simplified">Singapore - Chinese Simplified</option>
            <option value="malaysia-chinese-simplified">Malaysia - Chinese Simplified</option>
            ...
            <option value="united-states-vietnamese">United States - Vietnamese</option>
            ...
            <option value="dominican-republic-spanish">Dominican Republic - Spanish</option>
            ...
            <option value="united-states-chinese-simplified">United States - Chinese Simplified</option>
            <option value="united-states-japanese">United States - Japanese</option>
            ...
            <option value="republic-of-the-congo-english">Republic of the Congo - English</option>
            <option value="djibouti-english">Djibouti - English</option>
            <option value="equatorial-guinea-english">Equatorial Guinea - English</option>
            ...
            <option value="republic-of-the-cote-d-ivoire-english">Republic of the Côte d'Ivoire - English</option>
            <option value="rwanda-english">Rwanda - English</option>
            <option value="sao-tome-and-principe-english">São Tomé and Príncipe - English</option>
            ...
            <option value="republic-of-the-congo-french">Republic of the Congo - French</option>
            <option value="djibouti-french">Djibouti - French</option>
            <option value="equatorial-guinea-french">Equatorial Guinea - French</option>
            ...
            <option value="republic-of-the-cote-d-ivoire-french">Republic of the Côte d'Ivoire - French</option>
            ...
            <option value="equatorial-guinea-spanish">Equatorial Guinea - Spanish</option>
            <option value="portugal-english">Portugal - English</option>
            <option value="south-africa-afrikaans">South Africa - Afrikaans</option>
            <option value="canada-chinese-simplified">Canada - Chinese Simplified</option>
            ...
            <option value="czech-republic-english">Czech Republic - English</option>
            <option value="dominican-republic-english">Dominican Republic - English</option>
            ...
            <option value="libyan-arab-jamahiriya-english">Libyan Arab Jamahiriya - English</option>
            ...
            <option value="slovakia-slovak-republic-english">Slovakia (Slovak Republic) - English</option>
            <option value="slovenia-english">Slovenia - English</option>
            <option value="sri-lanka-english">Sri Lanka - English</option>
            <option value="taiwan-province-of-china-english">Taiwan Province Of China - English</option>
            ...
            <option value="equatorial-guinea-portuguese">Equatorial Guinea - Portuguese</option>
            <option value="eritrea-arabic">Eritrea - Arabic</option>
            <option value="guinea-bissau-portuguese">Guinea-Bissau - Portuguese</option>
            ...
            <option value="sao-tome-and-principe-portuguese">São Tomé and Príncipe - Portuguese</option>
            <option value="haiti-french">Haiti - French</option>
            <option value="democratic-republic-of-the-congo-english">Democratic Republic of the Congo - English</option>
            <option value="democratic-republic-of-the-congo-french">Democratic Republic of the Congo - French</option>
